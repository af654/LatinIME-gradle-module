...
public class DictionaryInfoUtils {
     ...
     */
    public static int getMainDictionaryResourceIdIfAvailableForLocale(final Context context, final Resources res,
            final Locale locale) {
        int resId;
        ...
        if (!locale.getCountry().isEmpty()) {
            ...
            if ((resId = res.getIdentifier(
                    dictLanguageCountry, "raw", context.getPackageName())) != 0) {
                return resId;
            }
        }
        ...
        if ((resId = res.getIdentifier(dictLanguage, "raw", context.getPackageName())) != 0) {
            return resId;
        }
     ...
     * @return main dictionary resource id
     */
    public static int getMainDictionaryResourceId(final Context context, final Resources res, final Locale locale) {
        int resourceId = getMainDictionaryResourceIdIfAvailableForLocale(context, res, locale);
        if (0 != resourceId) return resourceId;
        return res.getIdentifier(DEFAULT_MAIN_DICT, "raw", context.getPackageName());
    }
    ...
    public static ArrayList<DictionaryInfo> getCurrentDictionaryFileNameAndVersionInfo(
        ...
        for (final String localeString : assets.getLocales()) {
            ...
            final int resourceId =
                    DictionaryInfoUtils.getMainDictionaryResourceIdIfAvailableForLocale(context,
